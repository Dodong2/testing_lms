...
export function SearchBar({ onSearch, placeholder = "Search...", delay = 300 }: SearchBarProps) {
  ...
  return (
    <div  className="bg-white flex items-center rounded-3xl px-3 w-64 focus-within:w-96 shadow-[0_2px_4px_rgba(0,0,0,0.1)] transition-all duration-300 ease-in-out border-b-3 border-l-3 border-transparent hover:border-b-blue-500 hover:border-l-blue-500 focus-within:border-blue-500">
      <input
        type="text"
