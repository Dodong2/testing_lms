...
const Header = () => {
  ...
  return (
    <header className="sticky top-0 bg-[#00306E] p-4 z-10">
      ...
      {session.user.image && (
        <div className="absolute top-1 right-3 w-12 h-12 lg:top-2 lg:right-4 border-2 border-cyan-700 sm:w-11 sm:h-11 lg:w-11 lg:h-11 rounded-full overflow-hidden cursor-pointer active:scale-95 transition-transform duration-75"
          onClick={showProfile}>
